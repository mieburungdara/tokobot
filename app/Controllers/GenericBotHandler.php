...
class GenericBotHandler
{
    ...
    public function handle(): ?ServerResponse
    {
        ...
        // The `handle` method in the library takes care of command execution and sending responses.
        // We just need to return a valid ServerResponse to satisfy the type hint, as the actual HTTP response has already been sent.
