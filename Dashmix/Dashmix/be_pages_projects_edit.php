          ...
          <div class="col-lg-8 col-xl-5">
            ...
            <div class="row mb-4">
              <div class="col-md-6">
                ...
                <input type="text" class="js-datepicker form-control" id="dm-project-edit-deadline" name="dm-project-edit-deadline" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm/dd/yy" placeholder="mm/dd/yy" value="11/06/2024">
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-md-6">
