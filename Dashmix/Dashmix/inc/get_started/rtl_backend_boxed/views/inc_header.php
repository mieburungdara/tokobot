...
<header id="page-header">
  ...
  <div class="content-header">
    ...
    <div>
      ...
      <button type="button" class="btn btn-alt-secondary me-2" data-toggle="layout" data-action="header_search_on">
      ...
      <div class="dropdown d-inline-block">
        <button type="button" class="btn btn-alt-secondary" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <i class="fa fa-angle-down opacity-50 me-1"></i>
        </button>
        <div class="dropdown-menu dropdown-menu-lg p-0" aria-labelledby="page-header-user-dropdown">
          ...
          <div class="p-2">
            <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)">
              <div>
                <i class="fa fa-fw fa-globe text-black-50 ms-1"></i>
                Projects
              </div>
            ...
            <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)">
              <div>
                <i class="fa fa-fw fa-sync-alt text- text-black-50 ms-1"></i>
                Servers
              </div>
              <span class="badge rounded-pill bg-primary">3</span>
            </a>
            <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)">
              <div>
                <i class="fa fa-fw fa-users text- text-black-50 ms-1"></i>
                Customers
              </div>
              <span class="badge rounded-pill bg-primary">3</span>
            </a>
            ...
            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0)">
              <i class="fa fa-fw fa-user-circle text- text-black-50 ms-1"></i>
              Profile
            </a>
            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0)">
              <i class="fab fa-fw fa-paypal text- text-black-50 ms-1"></i>
              Billing
            </a>
            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0)">
              <i class="fa fa-fw fa-wrench text- text-black-50 ms-1"></i>
              Preferences
            </a>
            <div role="separator" class="dropdown-divider"></div>
    ...
    <div class="content-header">
      <form class="w-100" method="POST">
        <div class="input-group">
          <input type="text" class="form-control rounded-end" placeholder="Search your projects.." id="page-header-search-input" name="page-header-search-input">
          <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
          <button type="button" class="btn btn-alt-danger rounded-start" data-toggle="layout" data-action="header_search_off">
