        ...
        <tbody>
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 14, 2024 at 17:20
            </td>
            <td class="d-none d-xl-table-cell">
              January 15, 2024 at 16:34
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 13, 2024 at 15:36
            </td>
            <td class="d-none d-xl-table-cell">
              January 16, 2024 at 20:48
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 07, 2024 at 23:19
            </td>
            <td class="d-none d-xl-table-cell">
              January 10, 2024 at 15:12
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 04, 2024 at 15:12
            </td>
            <td class="d-none d-xl-table-cell">
              January 05, 2024 at 19:12
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 02, 2024 at 08:23
            </td>
            <td class="d-none d-xl-table-cell">
              January 07, 2024 at 21:
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 02, 2024 at 14:54
            </td>
            <td class="d-none d-xl-table-cell">
              January 05, 2024 at 20:18
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
          ...
          <tr>
            ...
            <td class="d-none d-xl-table-cell">
              January 01, 2024 at 12:20
            </td>
            <td class="d-none d-xl-table-cell">
              January 01, 2024 at 11:30
            </td>
            <td class="text-center">
              <a class="btn btn-sm btn-alt-secondary" href="be_pages_blog_post_edit.php">
                <i class="fa fa-fw fa-pencil-alt text-primary"></i>
