        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">An adventure of a lifetime</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on March 16, 2024 · <em class="text-muted">13 min</em>
                </div>
                <p class="mb-0">
        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">Learn to code</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on March 13, 2024 · <em class="text-muted">12 min</em>
                </div>
                <p class="mb-0">
                  Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet.. <a href="be_pages_blog_story.php">Read on</a>
                </p>
        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">Travel &amp; Work</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on March 6, 2024 · <em class="text-muted">9 min</em>
                </div>
                <p class="mb-0">
                  Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet.. <a href="be_pages_blog_story.php">Read on</a>
                </p>
        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">Spring is here</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on March 21, 2024 · <em class="text-muted">5 min</em>
                </div>
                <p class="mb-0">
                  Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet.. <a href="be_pages_blog_story.php">Read on</a>
                </p>
        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">Black &amp; White</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on June 5, 2024 · <em class="text-muted">7 min</em>
                </div>
                <p class="mb-0">
                  Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet.. <a href="be_pages_blog_story.php">Read on</a>
                </p>
        ...
        <div class="block-content p-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-8 col-lg-7 d-flex align-items-center">
              <div class="px-4 py-3">
                <h4 class="mb-1">
                  <a class="text-dark" href="be_pages_blog_story.php">Explore the city</a>
                </h4>
                <div class="fs-sm mb-2">
                  <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on June 1, 2024 · <em class="text-muted">8 min</em>
                </div>
                <p class="mb-0">
                  Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet.. <a href="be_pages_blog_story.php">Read on</a>
                </p>
    ...
    <div class="col-xl-4">
      ...
      <a class="block block-rounded block-link-shadow" href="be_pages_generic_profile.php">
        ...
        <div class="block-content block-content-full text-center">
          ...
          <div class="fs-lg fw-semibold"><?php $dm->get_name('female'); ?></div>
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content">
          <div class="push">
            <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on <a href="be_pages_blog_story.php">Exploring the world</a>
            <p class="mt-1">
              Awesome trip! Looking forward going there, I'm sure it will be a great experience!
            </p>
          </div>
          <div class="push">
            <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on <a href="be_pages_blog_story.php">Travel &amp; Work</a>
            <p class="mt-1">
              Thank you for sharing your story with us! I really appreciate the info, it will come in handy for sure!
            </p>
          </div>
          <div class="push">
            <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on <a href="be_pages_blog_story.php">Black &amp; White</a>
            <p class="mt-1">
              Really touching story.. I'm so happy everything went well at the end!
            </p>
          </div>
          <div class="push">
            <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on <a href="be_pages_blog_story.php">Sleep Better</a>
            <p class="mt-1">
