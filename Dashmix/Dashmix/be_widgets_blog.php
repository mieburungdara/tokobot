    ...
    <div class="col-lg-4">
      ...
      <a class="block block-rounded block-link-pop h-100 mb-0" href="javascript:void(0)">
        ...
        <div class="block-content">
          ...
          <p class="fs-sm">
            <span class="text-primary"><?php $dm->get_name(); ?></span> on March 30, 2024 · <span class="text-muted">9 min</span>
          </p>
          <p>
    ...
    <div class="col-lg-4">
      ...
      <a class="block block-rounded block-link-pop h-100 mb-0" href="javascript:void(0)">
        ...
        <div class="block-content">
          ...
          <p class="fs-sm">
            <span class="text-primary"><?php $dm->get_name(); ?></span> on March 24, 2024 · <span class="text-muted">8 min</span>
          </p>
          <p>
            Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet....
          </p>
    ...
    <div class="col-lg-4">
      ...
      <a class="block block-rounded block-link-pop h-100 mb-0" href="javascript:void(0)">
        ...
        <div class="block-content">
          ...
          <p class="fs-sm">
            <span class="text-primary"><?php $dm->get_name(); ?></span> on March 21, 2024 · <span class="text-muted">14 min</span>
          </p>
          <p>
            Anam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus justo amet....
          </p>
