      ...
      <div class="block block-rounded">
        ...
        <div class="block-content">
          <form action="db_wp_post.php" method="POST" onsubmit="return false;">
            <div class="mb-4">
              <input type="text" class="form-control py-3" id="post-title" name="post-title" placeholder="Add Title..">
            </div>
            <div class="mb-4">
              <!-- CKEditor 5 Classic (js-ckeditor5-classic id is initialized at the bottom of the page) -->
              <!-- For more info and examples you can check out http://ckeditor.com -->
              <textarea id="js-ckeditor5-classic" name="post-body"></textarea>
            </div>
          </form>
        </div>
      </div>
