  ...
  <div class="content content-top text-center">
    <div class="pt-4 pt-lg-6">
      <h1 class="fw-black mb-2">
        Premium dashboard UI framework for developers
      </h1>
    </div>
    <div class="row g-0 justify-content-center mb-6">
      <div class="col-lg-8">
        ...
        <div>
          <a class="btn btn-alt-success px-4 py-2 m-1" href="https://pixelcave.com/products/dashmix?purchase=true&ref=demo">
    ...
    <div class="row items-push-2x">
      ...
      <div class="col-md-6">
        ...
        <div class="d-flex">
          ...
          <div class="flex-grow-1">
            <h4 class="mb-1">Laravel 11 Starter Kit</h4>
            <p class="text-muted mb-0">
              Rocket start your custom Laravel project with the included starter kit! It includes vital page examples and main assets ready to work with Laravel Vite out of the box.
            </p>
          </div>
        </div>
  ...
  <div class="content">
    <div class="py-5 mt-3 mt-lg-5 text-center mb-3">
      ...
      <div class="row g-0 justify-content-center">
        <div class="col-lg-8">
          <p class="fs-5 mb-0">
            Power your dashboards with carefully crafted widgets. Choose from a huge collection and various categories, including but not limited to Tiles, Statistics, Media and Users.
          </p>
        </div>
      </div>
    </div>
...
<div class="content">
  <div class="py-5 py-md-7 text-center">
    <h2 class="h1 fw-black mb-2">
      Crafted with <i class="fa fa-fw fa-heart text-danger"></i> by <a class="link-fx" href="https://pixelcave.com">pixelcave</a>
    </h2>
    <p class="fs-5 mb-0">
  ...
  <div class="content content-full">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4 mb-5">
        ...
        <p class="mb-0 text-muted">
          Tons of icons to choose from including the latest Font Awesome 6 icon pack.
        </p>
      </div>
      <div class="col-sm-6 col-md-4 mb-5">
        <div class="my-3">
...
<div class="bg-body-light">
  <div class="content content-full">
    <div class="py-5 py-md-8 text-center">
      <h2 class="h1 fw-black mb-2">
        Dash<span class="text-primary">mix</span> was crafted with <i class="fa fa-fw fa-heart text-danger"></i> by <a class="text-primary link-fx" href="https://pixelcave.com">pixelcave</a>
      </h2>
      <p class="fs-lg mb-4">
