        ...
        <div class="row justify-content-center push">
          <div class="col-md-10">
            ...
            <div class="mb-4">
              ...
              <textarea id="js-ckeditor5-classic" name="dm-post-edit-post"></textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="row mb-4">
              <div class="col-xl-6">
                ...
                <input type="text" class="js-flatpickr form-control" id="dm-post-edit-publish-date" name="dm-post-edit-publish-date" data-enable-time="true" placeholder="Y-m-d H:i" value="2024-01-15 12:22">
              </div>
            </div>
          </div>
        </div>
