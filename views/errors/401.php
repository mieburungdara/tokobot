  ...
  <div class="row g-0 justify-content-end bg-xwork-op">
    <div class="hero-static col-md-5 d-flex flex-column bg-body-extra-light">
      ...
      <div class="flex-grow-1 d-flex align-items-center p-5 bg-body-light">
        <div class="w-100">
          <p class="text-danger fs-4 fw-bold text-uppercase mb-2">401 Error</p>
          <h1 class="fw-bold mb-2">Not Authorized</h1>
          <p class="fs-4 fw-medium text-muted mb-5">You are not authorized to access this page.</p>
